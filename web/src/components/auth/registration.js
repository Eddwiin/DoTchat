          ...
          <Col>
            <Form.Group controlId="lastName">
              ...
              <Form.Control
                ...
                isValid={nameValidator(this.state.lastName)}
                isInvalid={!nameValidator(this.state.lastName)}
              />
            </Form.Group>
            ...
            <Form.Group controlId="firstName">
              ...
              <Form.Control
                ...
                onChange={this.handleChange}
                isValid={nameValidator(this.state.firstName)}
                isInvalid={!nameValidator(this.state.firstName)}
              />
            </Form.Group>
