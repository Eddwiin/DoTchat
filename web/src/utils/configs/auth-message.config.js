...
const rulePasswordMessage = () => ({
    message: 'The password must contain : 8 characters, 1 number, 1 lowercase and 1 uppercase character.',
    type: 'info'
})
...
export { resetEmailMessage, emailExistMessage, rulePasswordMessage, passwordChangedMessage, userHasRegistredMessage }